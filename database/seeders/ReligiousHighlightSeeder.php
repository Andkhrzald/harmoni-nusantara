...
class ReligiousHighlightSeeder extends Seeder
{
    ...
    {
        $islam = ReligionCategory::where('slug', 'islam')->first();
        $kristen = ReligionCategory::where('slug', 'kristen')->first();
        $katolik = ReligionCategory::where('slug', 'katolik')->first();
        $hindu = ReligionCategory::where('slug', 'hindu')->first();
        $buddha = ReligionCategory::where('slug', 'buddha')->first();
        $konghucu = ReligionCategory::where('slug', 'konghucu')->first();

        $highlights = [
            // ─── ISLAM ────────────────────────────────────────────
            // Tempat Ibadah
            [
                'religion_id' => $islam->id,
                'type' => 'worship_place',
            ...
            [
                ...
                'image_url' => 'https://images.unsplash.com/photo-1600096194534-95cf5ece04cf?w=800&q=80',
            ...
            [
                ...
                'image_url' => 'https://images.unsplash.com/photo-1585747861115-37e2a17c76a7?w=800&q=80',
                'location' => null,
            ...
            [
                ...
                'image_url' => 'https://images.unsplash.com/photo-1584269600464-37b1b58b1f1b?w=800&q=80',
            ...
            [
                ...
                'image_url' => 'https://images.unsplash.com/photo-1515169067868-5387ec356754?w=800&q=80',
            ...
            [
                ...
                'image_url' => 'https://images.unsplash.com/photo-1531804226535-71dc18d589d6?w=800&q=80',
        ...
        DB::table('religious_highlights')->truncate();
